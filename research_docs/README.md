...
| **[../implement_docs/](../implement_docs/README.md)** | **How to build it** (English original; Vietnamese mirror in [../implement_docs_vi/](../implement_docs_vi/README.md)): task list with acceptance tests, code conventions, invariant → test map, module map, ADRs. Coding-agent instructions: [../CLAUDE.md](../CLAUDE.md) |
