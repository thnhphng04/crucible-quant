...
| INV-76 | The locked protocol hash covers what the monitor decides, not just its name | §3.1.11, ADR-0028 | Code | `tests/agent/test_compare.py::test_the_protocol_hash_covers_the_monitor_behaviour`, `::test_the_fingerprint_scenarios_straddle_the_decision_boundary` | P2-15 | ✅ |
