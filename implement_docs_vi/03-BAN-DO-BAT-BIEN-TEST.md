...
| INV-41 | PBO ≈ 0.5 trên nhiễu, → 0 khi có edge cài sẵn; một ví dụ tự tính theo định nghĩa của bài báo (không phải fixture số liệu công bố, O18) và khớp `purgedcv` | §3.2 | Code | `tests/validation/test_pbo.py::test_pbo_noise`, `::test_pbo_planted_edge`, `::test_pbo_reference_example`, `::test_matches_purgedcv`; cổng: `tests/validation/test_pbo_gate.py` | P1-03 | ✅ |
